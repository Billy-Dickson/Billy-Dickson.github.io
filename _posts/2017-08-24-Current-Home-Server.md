...
image:
   path: ../assets/img/posts/2017/2017-08-24-Current-Home-Server/TrueNAS-Scale.webp
---
...
Here’s a really good article [about power supplies](https://forums.freenas.org/index.php?threads/proper-power-supply-sizing-guidance.38811/&sa=D&source=editors&ust=1666005686712431&usg=AOvVaw3fWtXxbU1ao3xzj10ko_LA) and calculating the required power supply wattage. I initially started using 4 drives, but over time I managed to fill them up, at that point it rebuilt my server with 8 drives.
...
So, I’m looking for a 550 Watt power supply and since it seems to be recommended on the Freenas Forum, I’m going to buy the [Seasonic G550 550W 80+ Gold Certified PSU](https://www.amazon.com/Seasonic-SSR-550RM-Semi-Modular-CrossFire-Capacitor/dp/B00918MEZG) after reading a good review of the product [hon this website](https://www.legitreviews.com/seasonic-g-series-550w-ssr-550rm-power-supply-review_2148).
...
![TrueNAS Scale](../assets/img/posts/2017/2017-08-24-Current-Home-Server/TrueNAS-Scale.webp)
...
![Low Draw](../assets/img/posts/2017/2017-08-24-Current-Home-Server/Low_Draw.webp)

### High Draw (Server Starting)

![Hight Draw](../assets/img/posts/2017/2017-08-24-Current-Home-Server/High_Draw.webp)

### Average Draw (Running for a few hours)

![Average Draw](../assets/img/posts/2017/2017-08-24-Current-Home-Server/Average_Draw.webp)

As the homeserver's average draw is only 55W, the average cost per month is **£8.72**

The power meter plug (energy meter) can be purchased from [Amazon](https://www.amazon.co.uk/gp/product/B085S7Q1T4/ref=ppx_yo_dt_b_asin_title_o06_s00?ie=UTF8&psc=1) is the link.

## Case prior to build

![Fractal Design](../assets/img/posts/2017/2017-08-24-Current-Home-Server/Case.webp)

## Seasonic Power Supply

![Seasonic Power Supply](../assets/img/posts/2017/2017-08-24-Current-Home-Server/Power_Supply.webp)
